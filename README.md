...
<i> **Python-Only_Context_Log.py** </i> <br>
...
<i> **Ollama_Context_Log.py** </i> <br>
Uses a local LLM (Llama 3) to act as a filter. Still 80% Python, 20% AI. Analyzes email subjects and metadata to filter out administrative "noise". It checks a 3 year window (`TARGET_YEAR` $\pm$ 1) to ensure no context is lost from the previous or following years. Better if keywords alone produce too many irrelevant results.
